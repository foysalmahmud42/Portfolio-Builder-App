...
import com.foysal.portfolio.datamodel.PersonalInfo;
...
public class PreviewFragment extends ResumeFragment {
    ...
    private void createWebPrintJob(WebView webView) {
        ...
        tempWebView.loadDataWithBaseURL(null, htmlContent.toString(), "text/html", "utf-8", null);
        // Get a PrintManager instance
        PrintManager printManager = (PrintManager) getContext()
                .getSystemService(Context.PRINT_SERVICE);

        // Get a print adapter instance
        PrintDocumentAdapter printAdapter = tempWebView.createPrintDocumentAdapter();
